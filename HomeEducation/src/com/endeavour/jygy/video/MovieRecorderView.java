...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
    ...
    public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRecordMaxTime = a.getInteger(R.styleable.MovieRecorderView_record_max_time, 8);// 默认为10
    ...
    private void createRecordDir() {
        File sampleDir = new File(Environment.getExternalStorageDirectory() + File.separator + "jygy/video/");
        if (!sampleDir.exists()) {
            sampleDir.mkdirs();
        }
    ...
    private void initRecord() throws IOException {
        ...
        mMediaRecorder.setMaxDuration(8 * 1000);
