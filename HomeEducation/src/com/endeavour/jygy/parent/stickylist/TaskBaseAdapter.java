package com.endeavour.jygy.parent.stickylist;
...
public class TaskBaseAdapter extends BaseAdapter implements
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.task_list_item_layout, parent, false);
        ...
        holder.tv_task_name.setText(mCountries[position]);
