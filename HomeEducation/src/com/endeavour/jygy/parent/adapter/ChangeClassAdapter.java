...
public class ChangeClassAdapter extends BaseAdapter {
    ...
    private List<GetApplyHistoryListResp> resps = new ArrayList<GetApplyHistoryListResp>();
    ...
    @Override
    public GetApplyHistoryListResp getItem(int position) {
    ...
    private void initializeViews(GetApplyHistoryListResp resp, ViewHolder holder) {
    ...
    public void setDataChanged(List<GetApplyHistoryListResp> resps) {
