...
package com.endeavour.jygy.common.ui.precent;
 ...
 * create an instance of {@link PercentLayoutInfo} by calling
...
public class PercentLayoutHelper {
	...
	public static PercentLayoutInfo getPercentLayoutInfo(Context context,
		...
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_heightPercent);
		...
		// 1, 1, -1f);
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_marginPercent);
		// just for judge
		percentVal = getPercentVal(sizeStr, false);
		...
		// -1f);
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_marginLeftPercent);
		...
		// -1f);
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_marginTopPercent);
		percentVal = getPercentVal(sizeStr, false);
		if (percentVal != null) {
			if (Log.isLoggable(TAG, Log.VERBOSE)) {
		...
		// -1f);
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_marginRightPercent);
		percentVal = getPercentVal(sizeStr, true);
		if (percentVal != null) {
			if (Log.isLoggable(TAG, Log.VERBOSE)) {
		...
		// -1f);
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_marginBottomPercent);
		percentVal = getPercentVal(sizeStr, false);
		if (percentVal != null) {
			if (Log.isLoggable(TAG, Log.VERBOSE)) {
		...
		// -1f);
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_marginStartPercent);
		percentVal = getPercentVal(sizeStr, true);
		if (percentVal != null) {
			if (Log.isLoggable(TAG, Log.VERBOSE)) {
		...
		// -1f);
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_marginEndPercent);
		percentVal = getPercentVal(sizeStr, true);
		if (percentVal != null) {
			if (Log.isLoggable(TAG, Log.VERBOSE)) {
		...
		// textSizePercent
		sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_textSizePercent);
		percentVal = getPercentVal(sizeStr, false);
		if (percentVal != null) {
			if (Log.isLoggable(TAG, Log.VERBOSE)) {
	...
	private static PercentLayoutInfo.PercentVal getPercentVal(
		...
		boolean isBasedWidth = (isOnWidth && !lastAlpha.equals("h"))
				|| lastAlpha.equals("w");
		...
		public String toString() {
			return String.format(
					"PercentLayoutInformation width: %f height %f, margins (%f, %f, "
							+ " %f, %f, %f, %f)", widthPercent, heightPercent,
					leftMarginPercent, topMarginPercent, rightMarginPercent,
