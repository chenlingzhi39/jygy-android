...
import com.endeavour.jygy.common.base.BaseViewStateListener;
...
public class ProgressLayout extends RelativeLayout {
	...
	public void setBaseViewStateListener(
			BaseViewStateListener baseViewStateListener) {
	...
	private void init() {
		...
		// indeterminateProgressLarge = (ProgressBar)
		// mProgressView.findViewById(R.id.indeterminate_progress_large_library);
		// indeterminateProgressLarge.setIndeterminateDrawable(new
		// IndeterminateProgressDrawable(getContext()));
	...
	private void addContentViewIfPassable(View child) {
		if (child.getTag() == null
				|| (!child.getTag().equals(TAG_PROGRESS) && !child.getTag()
						.equals(TAG_ERROR))) {
