...
public final class CustomActivityOnCrash {
						...
						public void uncaughtException(Thread thread,
							...
							if (isStackTraceLikelyConflictive(throwable,
								...
								if (launchErrorActivityWhenInBackground
									...
									final Intent intent;
									if (BuildConfig.DEBUG) {// 测试模式下跳转到错误提示界面,否则直接重启应用
															// wu@[20150812]
										intent = new Intent(application,
												errorActivityClass);
	...
	private static Class<? extends Activity> guessRestartActivityClass(
		...
		resolvedActivityClass = CustomActivityOnCrash
				.getRestartActivityClassWithIntentFilter(context);
	...
	private static Class<? extends Activity> guessErrorActivityClass(
		...
		// If action is defined, use that
		resolvedActivityClass = CustomActivityOnCrash
				.getErrorActivityClassWithIntentFilter(context);
