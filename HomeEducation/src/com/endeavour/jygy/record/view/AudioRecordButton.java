package com.endeavour.jygy.record.view;
...
import com.endeavour.jygy.record.view.AudioManager.AudioStageListener;
...
public class AudioRecordButton extends Button implements AudioStageListener {
	...
	public interface AudioFinishRecorderListener{
		void onFinished(float seconds,String filePath,String fileName);
	}
		...
		case MotionEvent.ACTION_UP:
			...
			if (!isRecording || mTime < 0.6f) {
				...
				if (mListener!=null) {// 并且callbackActivity，保存录音
					mListener.onFinished(mTime, mAudioManager.getCurrentFilePath(),mAudioManager.getCurrentFileName());
				}
