...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            ivIcon = (CircleImageView) scrollViewLeftMenu.findViewById(R.id.ivIcon);
            tvName = (TextView) scrollViewLeftMenu.findViewById(R.id.tvName);
            tvClassName = (TextView) scrollViewLeftMenu.findViewById(R.id.tvClassName);
            tvId = (TextView) scrollViewLeftMenu.findViewById(R.id.tvId);
            rlTop = scrollViewLeftMenu.findViewById(R.id.rlTop);
        }
