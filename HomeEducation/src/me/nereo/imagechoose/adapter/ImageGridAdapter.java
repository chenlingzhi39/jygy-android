...
public class ImageGridAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		if (type == TYPE_CAMERA) {
			view = mInflater.inflate(R.layout.choose_list_item_camera,
					viewGroup, false);
			view.setTag(null);
		} else if (type == TYPE_TXT) {
			view = mInflater.inflate(R.layout.choose_list_item_text, viewGroup,
					false);
			view.setTag(null);
		} else if (type == TYPE_NORMAL) {
			ViewHolde holde;
			if (view == null) {
				view = mInflater.inflate(R.layout.choose_list_item_image,
						viewGroup, false);
			...
			if (holde != null) {
				...
				if (showSelectIndicator) {// 多选模式
					holde.iv_choose_area
							.setOnClickListener(new View.OnClickListener() {
								@Override
								public void onClick(View v) {
									Intent showIntent = new Intent(mContext,
											ShowActivity.class);
					...
					holde.iv_choose_area
							.setOnClickListener(new View.OnClickListener() {
								@Override
								public void onClick(View v) {
									File tmpFile = FileUtils
											.createTmpFile(mContext);
									ImageChooseApp.getInstance()
											.setSingleChooseFile(tmpFile);
